...
IRQMEM    = $0000 ; Start Memory location       $0000-$FFFF			IRQ Debug Memory Start
...
;-- ColourPET Options
COLOURVER = 1	; ColourPET Hardware Version	0=Beta,1=Normal/uPET		ColourRAM start: 0=$8400, 1=$8800 (use for VICE).
